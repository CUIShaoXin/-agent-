...
export const courseSessions: CourseSession[] = [
  {
    ...
    title: "Agent基础认知",
    eyebrow: "FOUNDATION",
    description: "理解 LLM 与 Agent 的区别，掌握 Agent 的核心组成。",
  ...
  },
  {
    ...
    title: "Agent Loop",
    eyebrow: "THE LOOP",
    description: "学习 Agent 核心循环，理解 Thought、Action 与 Observation。",
  ...
  },
  {
    ...
    title: "Tool Calling",
    eyebrow: "TOOLS",
    description: "学习 Function Calling、MCP、外部工具调用与 Schema 设计。",
  ...
  },
  {
    ...
    title: "Memory",
    eyebrow: "MEMORY",
    description: "理解短期记忆、长期记忆、Session 管理与 Checkpoint。",
  ...
  },
  {
    ...
    eyebrow: "CONTEXT",
    description: "学习 Token 限制、历史压缩、Summary Memory 与信息筛选。",
  ...
  },
  {
    ...
    description: "学习 Agent 运行轨迹、Debug、状态观察与 Error Recovery。",
